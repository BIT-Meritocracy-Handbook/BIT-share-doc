...
<!-- <div style="text-align: center;">
    ...
    <div style="display: inline-block; text-align: left; margin: 10px;">
        ...
        <div><strong>彭小刚 Xiaogang Peng</strong><div style="font-size: small">BIT副教授</div></div>
    </div>
</div> -->
* **姓名/化名**，要是敢写的话

## 联系与支持
我们项目的邮箱: <a href="mailto:project-lss@outlook.com">project-lss@outlook.com</a><br>
